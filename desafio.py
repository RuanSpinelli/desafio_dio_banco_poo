...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("Operação inválida, o valor é maior que o saldo disponível!")
...
class Deposito(Transasao):
    ...
    def registrar(self, conta):
        ...
        if sucesso_transacao:
            ...
            print("Falha ao registrar o depósito na conta.")
...
def exibir_extrato(clientes):
    ...
    if not transacoes:
        ...
        for transacao in transacoes:
            ...
            # Formatar os detalhes da transação com base no tipo de transação
...
def depositar(clientes):
    ...
    transasao = Deposito(valor)

    conta = recuperar_conta_cliente(cliente)
    if not conta:
        return
    cliente.realizar_transacao(conta, transasao)  
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("Operação falhou, fluxo de criação de conta encerrado!")
        return
